			...
			public void actionPerformed(ActionEvent e) {
				if (Valor.getText().length() == 0) {
					...
					MonedaRespuesta.setForeground(Color.red);
						...
						Moneda moneda = new Moneda(tipoMoneda1, Double.parseDouble(Valor.getText()));
						double divisa = moneda.sacarDivisa(tipoMoneda2);
						DecimalFormat formato2 = new DecimalFormat("#.##");
						MonedaRespuesta.setText("La equivalencia de " + tipoMoneda1 +" a " + tipoMoneda2 + " es: " +formato2.format(moneda.convert(divisa)));
